...
# 2025-12-20 Rethink AI
  ...
  3. 约束很重要，约束很重要，对于本身是强约束的任务，如果只是一味的面向Y/target的优化，得到的东西终究只是奇葩。比如LLM本身对应的任务本身应该是强约束的，所谓幻觉只是约束不够。 行业里面喧嚣的World Model，其实是不可能完美构造的，最终的Validator也很重要。
  4. 目前为止的几乎所有的AI算法，更多的强调了学习Learn/Train（先验），忽略了搜索/Search。
